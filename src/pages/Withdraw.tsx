        ...
        <div className="rounded-md overflow-hidden relative h-32 bg-panel">
          <div className="absolute inset-0 flex items-center justify-center text-panel-foreground">
            <div className="text-center">
              ...
              <p className="text-2xl font-serif font-bold">{formatMoney(profile?.balance ?? 0, c.currency)}</p>
            </div>
          </div>
        </div>

        <div>
          <p className="text-sm font-serif font-semibold mb-2">Banque de retrait</p>
